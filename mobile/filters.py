...
class MobileProductFilter(django_filters.FilterSet):
    ...
    selling_price =  django_filters.RangeFilter(field_name='variant__selling_price')
    wholesale_price = django_filters.RangeFilter(field_name='variant__wholesale_price')
